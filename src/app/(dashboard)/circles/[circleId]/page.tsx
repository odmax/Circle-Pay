...
import {
  ArrowLeft, Users, PiggyBank, Target, Settings, BookOpen, Repeat, TrendingUp, Clock, Lightbulb, Receipt, Scale, Check, FileText, Wallet, MessageCircle, Calendar, Vote, Sparkles, Zap, DollarSign, User, FolderKanban, MessageSquare, AlertCircle, ScrollText, Gauge,
} from "lucide-react"
...
const tabIconMap: Record<string, React.ElementType> = {
  ...
  Clock, Lightbulb, FileText, Wallet, MessageCircle, Calendar, Vote, Sparkles, Zap, DollarSign, User, FolderKanban, ScrollText, Gauge,
}
