...
export const CIRCLE_TYPE_CONFIGS: Record<string, CircleTypeConfig> = {
  STOKVEL: {
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.events, tabs.polls, tabs.assistant, tabs.contributions, tabs.members, tabs.payouts, tabs.constitution, tabs.balances, tabs.reports, tabs.wallet, tabs.activity, tabs.insights],
  },
  HOUSEMATE: {
    label: "Housemates",
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.events, tabs.assistant, tabs.expenses, tabs.contributions, tabs.balances, tabs.members, tabs.activity],
  },
  TRAVEL: {
    label: "Travel Group",
    ...
    defaultSettings: {},
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.events, tabs.assistant, tabs.contributions, tabs.expenses, tabs.balances, tabs.members, tabs.activity],
  },
  WEDDING: {
    label: "Wedding",
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.events, tabs.assistant, tabs.goals, tabs.contributions, tabs.expenses, tabs.members, tabs.activity],
  },
  SAVINGS: {
    label: "Savings Group",
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.assistant, tabs.goals, tabs.contributions, tabs.members, tabs.reports, tabs.wallet, tabs.activity, tabs.insights],
  },
  FAMILY: {
    label: "Family",
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.assistant, tabs.contributions, tabs.goals, tabs.expenses, tabs.members, tabs.wallet, tabs.activity],
  },
  CHURCH: {
    label: "Church Group",
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.events, tabs.assistant, tabs.contributions, tabs.goals, tabs.members, tabs.expenses, tabs.reports, tabs.wallet, tabs.activity],
  },
  INVESTMENT: {
    ...
    tabs: [tabs.trip, tabs.itinerary, tabs.budget, tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.events, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.assistant, tabs.contributions, tabs.goals, tabs.members, tabs.activity, tabs.reports, tabs.insights],
  },
  CUSTOM: {
    label: "Custom",
    ...
    tabs: [tabs.operations, tabs.automations, tabs.payments, tabs.projects, tabs.portfolio, tabs.opportunities, tabs.myStatus, tabs.myStatement, tabs.feed, tabs.assistant, tabs.contributions, tabs.expenses, tabs.goals, tabs.balances, tabs.constitution, tabs.members, tabs.activity],
  },
}
